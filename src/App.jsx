    ...
    <>
      ...
      <section className="navbar-no-2-section">
        <div className="right-nav-no-2-wrapper">
          ...
          <a href="#cau-truc" className="navbar-item">Lớp</a>
          <a href="#stories-6-8" className="navbar-item">Câu chuyện</a>
        </div>
        <div className="left-nav-no-2-wrapper">
          <a href="#tong-ket" className="navbar-item">Tổng kết</a>
        </div>
      </section>
      <section className="content-section">
            ...
            <div className="stories-body-lop">
              ...
              <div className="stories-body-wrapper-img-and-text">
                <div className="stories-wrapper-content">
                  ...
                  <div className="stories-text-wrapper">
                    <br />
                    <p>Mở đầu với đại hội chi đội lớp chúng tôi, mọi thành viên đều giơ cao cánh tay biểu quyết. Chúng tôi vạch ra những chỉ tiêu và kế hoạch thực hiện những mục tiêu ấy. Sự vui vẻ và phấn khởi là điều ai cũng thấy. Với tư cách là chi đội trưởng, bạn Trần Ngọc Gia Bảo phát biểu, tổng kết năm học 2023-2024 và đề ra những kế hoạch mà nhận được sự tán thành rất lớn. </p>
                  </div>
                </div>
                <div className="stories-wrapper-content">
                  <div className="stories-img-wrapper">
                  ...
                  <div className="stories-text-wrapper">
                    <br />
                    <p>Cuộc thi cắm hoa được ba bạn Gia Bảo, Kim Ngân và Khánh Vy tham gia. Đây là một cuộc thi vô cùng sáng tạo và mở mang trí thức rất lớn cho cả ba bạn. Với sự nhiệt huyết và sáng tạo của tuổi trẻ, ba bạn đã tạo nên một kết quả vô cùng xứng đáng. Kết thúc cuộc thi, ba bạn nhận được giải ba, góp phần tô điểm thêm cho dải thành tích của lớp. </p>
                  </div>
                </div>
                <div className="stories-wrapper-content">
                  <div className="stories-img-wrapper">
        ...
        <article className="Summary" id="tong-ket">
          <div className="summary-intro-wrapper">
            <h1>Tổng kết</h1> 
          </div>
          <div className="summary-content-wrapper">
            <p className="p-content-sum">Ba năm học cấp hai từ lớp 6 đến lớp 8 đã trôi qua với biết bao kỷ niệm đáng nhớ. Tôi vẫn còn nhớ những ngày đầu bỡ ngỡ khi bước vào môi trường mới, đầy lạ lẫm, nhưng rồi chúng tôi đã dần làm quen và trở thành một tập thể gắn bó. Trong suốt chặng đường ấy, bọn tôi đã trải qua không ít khó khăn, từ áp lực học tập đến những lần hiểu lầm, tranh cãi. Tuy vậy, chính nhờ sự động viên của thầy cô và sự sẻ chia giữa bạn bè, chúng tôi đã cùng nhau vượt qua và trưởng thành hơn. Bên cạnh việc học, chúng tôi còn tham gia nhiều hoạt động như văn nghệ, thể thao, hội trại, làm báo tường hay tập múa, tạo nên những kỷ niệm vô cùng đáng quý. Những tiếng cười, những khoảnh khắc cùng nhau cố gắng đã giúp tình bạn thêm bền chặt. Tôi nhận ra bản thân đã thay đổi, trở nên tự tin và có trách nhiệm hơn trước. Ba năm tuy không dài nhưng đủ để ghi dấu một phần thanh xuân đẹp đẽ. Và dù sau này mỗi người một con đường, bọn tôi vẫn sẽ luôn nhớ về quãng thời gian ý nghĩa này.</p>
            <div className="summary-video-container">
              <div className="summary-video-wrapper-container">
                <video 
                  src="/Tongket.mp4"
                  controls
                  muted
                  poster="POSTER_VIDEO_TONG_KET.jpg"  
                  className="summary-video"
                />
              </div>
              <div className="summary-content-wrapper-container">
                <p>Hành trình kì diệu ấy vẫn sẽ còn tiếp tục trong hơn một năm nữa, mở ra trước mắt bọn tôi nhiều cơ hội và thử thách mới. Bọn tôi vẫn chỉ là những học sinh đang trong độ tuổi trưởng thành, còn nhiều bỡ ngỡ và chưa hoàn thiện. Vì vậy, nếu có những sai sót trong quá trình học tập và rèn luyện, mong thầy cô và bố mẹ có thể thấu hiểu và bao dung cho chúng con. Chính sự quan tâm và chỉ bảo ấy sẽ giúp bọn tôi trưởng thành hơn từng ngày. Nhìn lại chặng đường đã qua, đó là một hành trình đầy ắp những kỷ niệm đáng nhớ. Bọn tôi không chỉ học được kiến thức mà còn học được cách sống, cách sẻ chia và gắn bó với nhau. Những khoảnh khắc vui vẻ, những tiếng cười và cả những lần vấp ngã đều trở thành một phần quý giá của tuổi học trò. Tất cả đã góp phần tạo nên một tập thể đoàn kết và giàu tình cảm. Đó thực sự là một trải nghiệm tuyệt vời mà bọn tôi luôn trân trọng. Những kỷ niệm ấy sẽ mãi in sâu trong tâm trí mỗi người và theo bọn tôi trên chặng đường phía trước.</p>
              </div>
            </div>
          </div>
        </article>
      ...
      <nav className="navbar">
        ...
        <a href = "#cau-truc" className="item-link"><div className="item">
            ...
            <span className="item-text" style={{ index: 1 }}>Lớp</span>
        </div></a>

        <a href = "#stories-6-8" className="item-link"><div className="item">
            <span className="material-icons">library_books</span>
            <span className="item-text" style={{ index: 2 }}>Câu chuyện</span>
        </div></a>

        <a href = "#tong-ket" className="item-link"><div className="item">
            <span className="material-icons">book</span>
            <span className="item-text" style={{ index: 3 }}>Tổng kết</span>
        </div></a>
      ...
      <footer className="footer">
        <div className="footer-container">
          ...
          <div className="footer-col">
            <h2>Class 8/2</h2>
            <p className="footer-address">Trường THCS Nguyễn Du, phường Bàn Thạch, TP. Đà Nẵng, Việt Nam</p>
            <p>Nơi lưu giữ kỷ niệm tuổi học trò đáng nhớ.</p>
          </div>

          <div className="footer-col">
            <h3>Liên kết</h3>
            <a href="#top">Trang chủ</a>
            <a href="#stories-6-8">Hoạt động</a>
          </div>
